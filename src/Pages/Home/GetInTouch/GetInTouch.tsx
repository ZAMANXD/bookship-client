...
const GetInTouch = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch('https://bookship-server.vercel.app/subscribe', {
        method: 'POST',
      ...
      <div className="bg-gradient-to-bl from-violet-600 to-indigo-500 mt-10 py-14 custom-bg rounded-lg mx-2 flex flex-col items-center">
        ...
        >
          ...
          >
            ...
            />
            <button
              className="bg-rose-500 text-white m-1 font-medium px-6 py-3 rounded-full hover:bg-rose-600 hidden lg:block "
            >
              Subscribe
            </button>
            <button
