        ...
        <div className='max-w-7xl mx-auto lg:py-10'>
            <div className='grid grid-cols-1 lg:grid-cols-[1fr_3fr] gap-5'>
                <div className='flex flex-col gap-y-2 mx-5 lg:mx-0 mt-5 lg:mt-0'>
                    <NavLink to={'/books/bookprice'} className={`bg-gray-200 rounded-md p-3 text-center`}>Price - Low to High</NavLink>
                    <NavLink to={'/books'} className={`bg-gray-200 rounded-md p-3 text-center`}>Price - High to Low</NavLink>
